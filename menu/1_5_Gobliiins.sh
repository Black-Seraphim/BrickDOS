...
MENU_TXT="/opt/brickdos/menu/1_5_Gobliiins.txt"

# --- Kategorie-Skripte (hier hardcodiert verdrahten) ---
KEY1="/opt/brickdos/scummvm/start-pi/Gobliiins.sh"
KEY2="/opt/brickdos/scummvm/start-pi/Gobliins 2.sh"
KEY3="/opt/brickdos/scummvm/start-pi/Goblins 3.sh"
