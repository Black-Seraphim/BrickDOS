...
- [`docs/FolderStructure.md`](docs/FolderStructure.md) – directory layout used by BrickDOS
- [`docs/GameMapping.csv`](docs/GameMapping.csv) – mapping between game titles and launcher scripts
